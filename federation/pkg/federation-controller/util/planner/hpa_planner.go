...
func NewHpaPlanner(preferences *fedapi.ReplicaAllocationPreferences) Planner {
...
func (p *HpaPlanner) Plan(replicasToDistribute int64, availableClusters []string, currentReplicaCount map[string]int64,
