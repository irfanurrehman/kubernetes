...
func TestAutoscalerController(t *testing.T) {
	...
	checkHpaTestConditions(t, hpa, hpa1, hpa2)
...
// TODO: move this to hpa adapters folder
// and test individual functions.
// or
// Add tests for remaining reconcile hook functions here.
func TestHpaAdapter_ReconcileHook(t *testing.T) {
	...
	for testName, testCase := range testCases {
		t.Run(testName, func(t *testing.T) {
			...
			checkHpaTestConditions(t, testCase.fedHpa, lhpas...)
...
func checkHpaTestConditions(t *testing.T, fedHpa *autoscalingv1.HorizontalPodAutoscaler, hpas ...*autoscalingv1.HorizontalPodAutoscaler) {
	minTotal := int32(0)
	maxTotal := int32(0)
